...
public class SkippingIgnoringPopups {
            ...
            try {
                ...
                if (screenShotName != null && !screenShotName.isEmpty()) {
                   ...
                   // driver.manage().window().fullscreen();
                    ...
                    //driver.manage().window().setSize(new Dimension(375, 14050)); // Match Figma width
                    ...
                    ((JavascriptExecutor) driver).executeScript(
                    	    ...
                    	    "const popupSelectors = ['.modal', '.popup', '[role=\"dialog\"]', '[aria-modal=\"true\"]'];" +
